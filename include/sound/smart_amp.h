...
/*
 * Re value to be read from kernel space
*/
//FIXME
//enable the persist-lg directory once the drm directory is available
#if 1
#define SMARTAMP_SPEAKER_CALIBDATA_FILE  "/mnt/vendor/persist-lg/audio/smartamp_calib.bin"
#else
#define SMARTAMP_SPEAKER_CALIBDATA_FILE  "/mnt/vendor/persist/audio/smartamp_calib.bin"
#endif
