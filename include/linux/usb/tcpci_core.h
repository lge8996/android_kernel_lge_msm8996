...
#define TYPEC_DBG(format, args...)	\
	pr_debug(CONFIG_TCPC_DBG_PRESTR "TYPEC:" format, ##args)
#else
#define TYPEC_DBG(format, args...)
#endif
...
#ifdef CONFIG_LGE_USB
#define TCPC_INFO(format, args...)	\
	pr_debug(CONFIG_TCPC_DBG_PRESTR "TCPC:" format, ##args)
#else
...
#ifdef CONFIG_LGE_USB
#define DPM_INFO(format, args...)	\
	pr_debug(CONFIG_TCPC_DBG_PRESTR "DPM:" format, ##args)
#else
#define DPM_INFO(format, args...)
#endif
#endif /* DPM_DBG_INFO */
...
#ifdef CONFIG_LGE_USB
#define PD_ERR(format, args...)	\
	pr_debug(CONFIG_TCPC_DBG_PRESTR "PD-ERR:" format, ##args)
#else
#define PD_ERR(format, args...)
#endif
#endif /* PD_ERR_ENABLE */
...
#ifdef CONFIG_LGE_USB
#define PE_INFO(format, args...)	\
	pr_debug(CONFIG_TCPC_DBG_PRESTR "PE:" format, ##args)
#else
#define PE_INFO(format, args...)
#endif
...
#ifdef CONFIG_LGE_USB
#define PE_EVT_INFO(format, args...) \
	pr_debug(CONFIG_TCPC_DBG_PRESTR "PE-EVT:" format, ##args)
#else
#define PE_EVT_INFO(format, args...)
#endif
...
#ifdef CONFIG_LGE_USB
#define DP_INFO(format, args...)	\
	pr_debug(CONFIG_TCPC_DBG_PRESTR "DP:" format, ##args)
#else
#define DP_INFO(format, args...)
#endif
...
#ifdef CONFIG_LGE_USB
#define UVDM_INFO(format, args...)	\
	pr_debug(CONFIG_TCPC_DBG_PRESTR "UVDM:" format, ##args)
#else
#define UVDM_INFO(format, args...)
#endif
#endif
...
#ifdef CONFIG_LGE_USB
#define TCPM_DBG(format, args...)	\
	pr_debug(CONFIG_TCPC_DBG_PRESTR "TCPM:" format, ##args)
#else
#define TCPM_DBG(format, args...)
#endif
#endif
...
#ifdef CONFIG_LGE_USB
#define DC_INFO(format, args...)	\
	pr_debug(CONFIG_TCPC_DBG_PRESTR "DC> " format, ##args)
#else
#define DC_INFO(format, args...)
#endif
#endif
